...
namespace TicketManagement.DataPersistence.Migrations
{
    ...
    [Migration("20220521135951_EventsSeeding")]
    partial class EventsSeeding
    {
            ...
            modelBuilder.Entity("TicketManagement.Domain.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2022, 11, 21, 15, 59, 50, 992, DateTimeKind.Local).AddTicks(8644),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2023, 2, 21, 15, 59, 50, 992, DateTimeKind.Local).AddTicks(8743),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2022, 9, 21, 15, 59, 50, 992, DateTimeKind.Local).AddTicks(8807),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2022, 9, 21, 15, 59, 50, 992, DateTimeKind.Local).AddTicks(8865),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2023, 3, 21, 15, 59, 50, 992, DateTimeKind.Local).AddTicks(8924),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2023, 1, 21, 15, 59, 50, 992, DateTimeKind.Local).AddTicks(8996),
