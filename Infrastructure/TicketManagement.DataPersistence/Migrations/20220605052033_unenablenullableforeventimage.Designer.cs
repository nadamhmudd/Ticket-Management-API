...
namespace TicketManagement.DataPersistence.Migrations
{
    ...
    [Migration("20220605052033_unenablenullableforeventimage")]
    partial class unenablenullableforeventimage
    {
            ...
            modelBuilder.Entity("TicketManagement.Domain.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2022, 12, 5, 7, 20, 33, 20, DateTimeKind.Local).AddTicks(8413),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2023, 3, 5, 7, 20, 33, 20, DateTimeKind.Local).AddTicks(8495),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2022, 10, 5, 7, 20, 33, 20, DateTimeKind.Local).AddTicks(8540),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2022, 10, 5, 7, 20, 33, 20, DateTimeKind.Local).AddTicks(8590),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2023, 4, 5, 7, 20, 33, 20, DateTimeKind.Local).AddTicks(8637),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2023, 2, 5, 7, 20, 33, 20, DateTimeKind.Local).AddTicks(8689),
